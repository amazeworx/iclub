...
<form method="post" id="package_selection" class="listing-package-selection">
	...
	?>
		...
		<?php if ($packages) : ?>
			...
			<p>Buying an online business at Investors Club is completely free. You can make offers, communicate with sellers, and complete the entire process without spending a penny. </p>
			</p>We offer additional marketing packages to increase the visibility of your listings. These packages bundle various marketing add-ons together at a discount, providing a cost-effective way to boost your listing's reach. Please note that these packages are only available at the time of initial listing submission. </p><br />
