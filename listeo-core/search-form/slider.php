...
$slider_classes = '';
if (isset($data->class)) {
	$slider_classes .= esc_attr($data->class);
}
if (isset($data->css_class)) {
	$slider_classes .= esc_attr($data->css_class);
}
?>

<!-- Range Slider -->
<div class="<?php echo $slider_classes; ?>">
	<!-- Range Slider -->
	<?php
	...
	?>
	Test
	<div class="range-slider-container <?php if ($flag_enabled) {
																				echo 'no-to-disable';
																			} ?>">
